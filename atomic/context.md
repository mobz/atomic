...
- `atomic/` reserved for: `spec.md` (ephemeral), `context.md`, `delta.md`, `.gitkeep` only.
...
- Each command in bin/lib/atomic-{status,progress,reset,show-spec,show-context,commit,push,clean,help}.
